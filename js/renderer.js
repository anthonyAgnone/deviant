...
const Compositor = require("./modules/Compositor");
const Timer = require("./modules/Timer");
const { loadLevel } = require("./modules/loaders.js");
const { createHero, createProj } = require("./modules/entities");
const Keyboard = require("./modules/KeyboardState");
const Camera = require("./modules/Camera");
const { getMousePos } = require("./modules/mousePos");
const {
  setInitialPosition,
  addKeyMapping
} = require("./modules/helperFunctions");
const { drawOutline } = require("./modules/drawOutline");
const { collisionDetect } = require("./modules/collisionDetect");
const { collisionDetectProj } = require("./modules/collisionDetectProj");
const { levelTransition } = require("./modules/levelTransition");
...
const SpritesJS = require("./modules/sprites.js");
const { Vec2, interpolate, lerp } = require("./modules/math");
